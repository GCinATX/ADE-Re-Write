...
class cfgWeapons
{
	...
	class zulu_larv7000;
	//Rebreather
	class ade_item_rebreather_1: zulu_larv7000
	{
		scope = 2;
		nameSound = "";
		displayName = "ADE Version [ZXX] Draeger LAR-V 7000";
		descriptionShort="Milspec rebreather for various gases.";
		author = "[ADE]";
		picture = "\ZuluCustomG3\logo\ZXX.paa";
		model = "\ZuluCustomDiving\draeger.p3d";
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"ZuluCustomDiving\tx\respirator_co.paa","ZuluCustomDiving\tx\respirator_co.paa","ZuluCustomDiving\tx\respirator_co.paa"};
		hiddenUnderwaterSelections[] = {"hide","hide2"};
		hiddenUnderwaterSelectionsTextures[] = {"ZuluCustomDiving\tx\respirator_co.paa","ZuluCustomDiving\tx\respirator_co.paa","ZuluCustomDiving\tx\respirator_co.paa"};
		class ItemInfo: VestItem
		{
			uniformModel = "ZuluCustomDiving\Draeger.p3d";
			vestType = "Rebreather";
	...
	class UKSF_LARV_1;
	//Rebreather
	class ade_item_rebreather_2: UKSF_LARV_1
	{
		scope = 2;
		nameSound = "";
		displayName = "ADE Version LAR-V Rebreather (Molle)";
		descriptionShort="Milspec rebreather for various gases.";
		author = "[ADE]";
		picture = "\ZuluCustomG3\logo\ZXX.paa";
		...
		hiddenUnderwaterSelectionsTextures[] = {"\DiveGear\data\scuba_attachments_co.paa","\DiveGear\data\scuba_attachments_co.paa","\A3\characters_f\data\visors_ca.paa"};
		class ItemInfo: VestItem
		{
	...
	class UKSF_LARV_2;
	//Rebreather
	class ade_item_rebreather_3: UKSF_LARV_2
	{
		scope = 2;
		nameSound = "";
		displayName = "ADE Version LAR-V Rebreather";
		descriptionShort="Milspec rebreather for various gases.";
		author = "[ADE]";
		picture = "\ZuluCustomG3\logo\ZXX.paa";
